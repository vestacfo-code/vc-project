        ...
        components={{
          ...
          code: ({ children, className }) => {
            ...
            return isInline ? (
              ...
              <code className={`block bg-zinc-100 dark:bg-zinc-800 p-2 rounded text-sm font-mono overflow-x-auto ${className}`}>{children}</code>
            );
          },
          pre: ({ children }) => <pre className="bg-zinc-100 dark:bg-zinc-800 p-3 rounded-lg overflow-x-auto mb-2">{children}</pre>,
        }}
      >
        {content}
      </ReactMarkdown>
