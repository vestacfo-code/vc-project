  ...
  public: {
    Tables: {
      ai_summaries: {
        ...
        Relationships: [
          {
            foreignKeyName: "ai_summaries_hotel_id_fkey"
            columns: ["hotel_id"]
            isOneToOne: false
      ...
      anomalies: {
        ...
        Relationships: [
          {
            foreignKeyName: "anomalies_hotel_id_fkey"
            columns: ["hotel_id"]
            isOneToOne: false
            referencedRelation: "hotels"
            referencedColumns: ["id"]
      ...
      budget_targets: {
        ...
        Relationships: [
          {
            foreignKeyName: "budget_targets_hotel_id_fkey"
            columns: ["hotel_id"]
            isOneToOne: false
            referencedRelation: "hotels"
            referencedColumns: ["id"]
      ...
      daily_metrics: {
        ...
        Relationships: [
          {
            foreignKeyName: "daily_metrics_hotel_id_fkey"
            columns: ["hotel_id"]
            isOneToOne: false
            referencedRelation: "hotels"
            referencedColumns: ["id"]
      ...
      hotel_chat_messages: {
        ...
        Relationships: [
          {
            foreignKeyName: "hotel_chat_messages_session_id_fkey"
            columns: ["session_id"]
            isOneToOne: false
            referencedRelation: "hotel_chat_sessions"
            referencedColumns: ["id"]
          },
        ]
      }
      hotel_chat_sessions: {
        ...
        Relationships: [
          {
            foreignKeyName: "hotel_chat_sessions_hotel_id_fkey"
            columns: ["hotel_id"]
            isOneToOne: false
            referencedRelation: "hotels"
            referencedColumns: ["id"]
      ...
      hotel_notifications: {
        ...
        Relationships: [
          {
            foreignKeyName: "hotel_notifications_hotel_id_fkey"
            columns: ["hotel_id"]
            isOneToOne: false
            referencedRelation: "hotels"
            referencedColumns: ["id"]
      ...
      notification_preferences: {
        Row: {
          anomaly_email: boolean | null
          anomaly_whatsapp: boolean | null
          daily_briefing_email: boolean | null
          daily_briefing_whatsapp: boolean | null
          hotel_id: string
          id: string
          quiet_hours_end: string | null
          quiet_hours_start: string | null
          sync_error_email: boolean | null
          updated_at: string
          user_id: string
      ...
      partner_leads: {
        ...
        Relationships: [
          {
            foreignKeyName: "partner_leads_hotel_id_fkey"
            columns: ["hotel_id"]
            isOneToOne: false
            referencedRelation: "hotels"
            referencedColumns: ["id"]
      ...
      recommendations: {
        ...
        Relationships: [
          {
            foreignKeyName: "recommendations_hotel_id_fkey"
            columns: ["hotel_id"]
            isOneToOne: false
            referencedRelation: "hotels"
            referencedColumns: ["id"]
      ...
      revenue_by_channel: {
        ...
        Relationships: [
          {
            foreignKeyName: "revenue_by_channel_hotel_id_fkey"
            columns: ["hotel_id"]
            isOneToOne: false
            referencedRelation: "hotels"
            referencedColumns: ["id"]
