...
const Onboarding = () => {
  ...
  const steps = [{
      ...
      ease: "easeOut"
        ...
        duration: 0.5
            ...
            <div className="space-y-6">
              <h1 className="text-6xl md:text-7xl font-bold text-vesta-navy">
                Welcome to Vesta!
              </h1>
              <p className="text-2xl md:text-3xl text-vesta-navy/80 max-w-2xl mx-auto font-light">
    ...
    component: <motion.div initial={{
      ...
      duration: 0.4
          ...
          delay: 0.1,
          duration: 0.5
        }} className="text-5xl md:text-6xl font-bold text-vesta-navy">
          ...
          duration: 0.5
              ...
              <Input placeholder="Type your company name..." value={data.companyName} onChange={e => updateData('companyName', e.target.value)} className="text-3xl py-8 text-center border-0 bg-transparent focus-visible:ring-0 focus-visible:ring-offset-0 text-vesta-navy placeholder:text-vesta-navy-muted" autoFocus onKeyDown={e => {
          ...
          delay: 0.3,
          duration: 0.5
        }} className="text-vesta-navy/65 text-lg">
    ...
    component: <motion.div initial={{
      ...
      duration: 0.4
          ...
          }} className="glass-card p-6 text-left rounded-2xl hover:shadow-xl transition-all text-lg font-medium text-vesta-navy hover:bg-vesta-mist/25">
                  {industry}
                </motion.button>)}
            </motion.div>
          </div>
          ...
          duration: 0.5
            ...
            setTimeout(nextStep, 400);
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <span className="text-xl font-medium text-vesta-navy">{option.label}</span>
                  </div>
                </motion.button>)}
            </motion.div>
          </div>
    ...
    component: <motion.div initial={{
      ...
      duration: 0.4
          ...
          duration: 0.5
            ...
            setTimeout(nextStep, 400);
          }} className="glass-card p-6 text-center rounded-2xl hover:shadow-xl transition-all text-xl font-medium text-vesta-navy hover:bg-vesta-mist/25">
                  {type}
                </motion.button>)}
            </motion.div>
          </div>
    ...
    component: <motion.div initial={{
      ...
      duration: 0.4
          ...
          delay: 0.2,
          duration: 0.5
        }} className="text-xl text-vesta-navy/80">
          ...
          duration: 0.5
            ...
            return <motion.button key={goal.id} initial={{
              ...
              scale: 0.97
            }} onClick={() => toggleArrayItem('mainGoals', goal.id)} className={`glass-card p-6 rounded-2xl transition-all ${isSelected ? 'bg-vesta-mist/40 shadow-xl border-2 border-vesta-navy/25' : 'hover:shadow-lg'}`}>
                    <div className="flex items-center space-x-3">
                      <Icon className={`w-6 h-6 ${isSelected ? 'text-vesta-navy' : 'text-vesta-navy/80'}`} />
                      <span className={`text-lg font-medium ${isSelected ? 'text-vesta-navy' : 'text-vesta-navy'}`}>
                        {goal.label}
                      </span>
                  ...
                  damping: 15
                          ...
                          <Check className="w-6 h-6 text-vesta-navy ml-auto" />
                        </motion.div>}
                    </div>
                  </motion.button>;
          })}
          ...
          duration: 0.3
                ...
                <Button onClick={nextStep} size="lg" className="text-lg px-10 py-6 bg-vesta-navy hover:bg-vesta-navy-muted/30 text-white shadow-lg hover:shadow-xl transition-all duration-300 rounded-2xl">
    ...
    component: <motion.div initial={{
      ...
      duration: 0.4
          ...
          duration: 0.5
              ...
              <Textarea placeholder="Describe what your business does, who you serve, and what makes you unique..." value={data.description} onChange={e => updateData('description', e.target.value)} className="text-lg min-h-40 border-0 bg-transparent focus-visible:ring-0 text-vesta-navy placeholder:text-vesta-navy-muted resize-none" rows={8} />
              <div className="absolute bottom-8 right-8 text-sm font-medium text-vesta-navy/65 bg-white/50 px-3 py-1 rounded-full">
          ...
          opacity: 1
        }} className="text-sm text-vesta-navy/65">
    ...
    component: <motion.div initial={{
      ...
      duration: 0.4
          ...
          duration: 0.5
              ...
              <ScrollText className="w-10 h-10 text-vesta-navy/90" />
              <h1 className="text-4xl md:text-5xl font-bold text-vesta-navy">
                Terms of Service
              </h1>
            </motion.div>
            <motion.p initial={{
          ...
          delay: 0.2,
          duration: 0.5
        }} className="text-lg text-vesta-navy/80">
            ...
            >
              <div className="prose prose-sm prose-gray max-w-none space-y-4">
                <h3 className="text-lg font-semibold text-vesta-navy">1. Acceptance of Terms</h3>
                ...
                <h3 className="text-lg font-semibold text-vesta-navy">2. Description of Service</h3>
                <p className="text-vesta-navy/80 text-sm">
                ...
                <h3 className="text-lg font-semibold text-vesta-navy">3. User Responsibilities</h3>
                <p className="text-vesta-navy/80 text-sm">
                ...
                <h3 className="text-lg font-semibold text-vesta-navy">4. Data Privacy</h3>
                <p className="text-vesta-navy/80 text-sm">
                ...
                <h3 className="text-lg font-semibold text-vesta-navy">5. Intellectual Property</h3>
                <p className="text-vesta-navy/80 text-sm">
                  The Service and its original content, features, and functionality are owned by Vesta and are 
                  protected by international copyright, trademark, and other intellectual property laws.
                </p>
                
                <h3 className="text-lg font-semibold text-vesta-navy">6. Limitation of Liability</h3>
                <p className="text-vesta-navy/80 text-sm">
                ...
                <h3 className="text-lg font-semibold text-vesta-navy">7. Termination</h3>
                <p className="text-vesta-navy/80 text-sm">
                ...
                <h3 className="text-lg font-semibold text-vesta-navy">8. Changes to Terms</h3>
                <p className="text-vesta-navy/80 text-sm">
                  We may modify these Terms of Service at any time. Continued use of the Service after changes 
                  constitutes acceptance of the modified terms.
                </p>
                
                <div className="pt-4 border-t border-vesta-navy/10 mt-6">
                  <p className="text-xs text-vesta-navy/65 italic">
            ...
            >
              <Checkbox 
                ...
                className="w-5 h-5 border-2 border-vesta-navy/12 data-[state=checked]:bg-vesta-navy data-[state=checked]:border-vesta-navy"
              />
              <label 
                htmlFor="terms" 
                className={`text-sm ${hasScrolledTerms ? 'text-vesta-navy/90 cursor-pointer' : 'text-vesta-navy-muted'}`}
              >
            ...
            {!hasScrolledTerms && (
              <motion.p 
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                className="text-xs text-vesta-navy/65"
              >
            ...
            {data.termsAccepted && (
              ...
              >
                <Button 
                  onClick={nextStep} 
                  size="lg" 
                  className="text-lg px-10 py-6 bg-vesta-navy hover:bg-vesta-navy-muted/30 text-white shadow-lg hover:shadow-xl transition-all duration-300 rounded-2xl"
                >
                  Continue <ArrowRight className="w-5 h-5 ml-2" />
                </Button>
              </motion.div>
      ...
      duration: 0.6
        ...
        damping: 15
          ...
          ease: "easeOut"
            ...
            delay: 0.4,
            duration: 0.5
          }} className="text-6xl md:text-7xl font-bold text-vesta-navy">
                Perfect!
              </motion.h1>
              <motion.p initial={{
            y: 20,
            ...
            delay: 0.5,
            duration: 0.5
          }} className="text-2xl md:text-3xl text-vesta-navy/80 max-w-2xl mx-auto font-light">
        ...
        duration: 0.5
            ...
            <Button onClick={handleComplete} disabled={isSubmitting} size="lg" className="text-lg px-10 py-6 bg-vesta-navy hover:bg-vesta-navy-muted/30 text-white shadow-lg hover:shadow-xl transition-all duration-300 rounded-2xl disabled:opacity-50">
              {isSubmitting ? <>
  ...
  if (loading) {
    return <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
        ...
        scale: 1
          ...
          <p className="text-vesta-navy/80 text-xl font-medium">Setting up your experience...</p>
        </motion.div>
      </div>;
  }
  return <div className="min-h-screen relative overflow-hidden">
      ...
      x: -20
          ...
          <ArrowLeft className="w-6 h-6 text-vesta-navy/90" />
        </motion.button>}
      ...
      opacity: 1,
      y: 0
    }} className="fixed top-8 right-8 z-40 text-sm font-semibold text-vesta-navy/90 glass-card px-5 py-3 rounded-full shadow-lg">
