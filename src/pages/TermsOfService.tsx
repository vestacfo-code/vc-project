          ...
          <div className="container mx-auto px-4 py-16 max-w-4xl">
            ...
            <div className="bg-white/70 backdrop-blur-xl border border-white/60 rounded-2xl p-6 md:p-10 shadow-[0_8px_32px_rgba(0,0,0,0.06)]">
              <div className="prose prose-gray max-w-none space-y-8">
                ...
                <section>
                  <h2 className="text-xl font-semibold text-gray-900 mb-3">2. Accuracy Limitations</h2>
                ...
                <section>
                  <h2 className="text-xl font-semibold text-gray-900 mb-3">5. Data Privacy and Security</h2>
                  <p className="text-gray-600 leading-relaxed mb-3">
