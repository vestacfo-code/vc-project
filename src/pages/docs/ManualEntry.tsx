  ...
  return (
    ...
    >
      <section id="when" className="mb-12">
        <h2 className="text-2xl font-semibold text-white mb-4">When to Use Manual Entry</h2>
      ...
      <section id="types" className="mb-12">
        <h2 className="text-2xl font-semibold text-white mb-4">Available Data Types</h2>
        <div className="grid gap-4">
          ...
          <div className="bg-[#1a1a1a] border border-white/10 rounded-xl p-4">
            <h4 className="text-white font-medium mb-2">Expenses</h4>
      ...
      <section id="adding" className="mb-12">
        ...
        <ol className="list-decimal list-inside text-slate-400 space-y-3">
          ...
          <li>Click <strong className="text-white">"Analyze Financial Data"</strong> to submit</li>
        </ol>
      </section>

      <section id="editing" className="mb-12">
        <h2 className="text-2xl font-semibold text-white mb-4">Re-Analyzing Data</h2>
        ...
        <ul className="list-disc list-inside text-slate-400 space-y-2">
          ...
          <li>Click <strong className="text-white">"Analyze Financial Data"</strong> to generate new insights</li>
        </ul>
        <div className="bg-[#1a1a1a] border border-white/10 rounded-xl p-4 mt-4">
          <p className="text-sm text-slate-400">
            💡 <strong className="text-white">Tip:</strong> For more detailed analysis, consider uploading financial documents (CSV, Excel, PDF) instead of manual entry.
          </p>
        </div>
      </section>
    </DocsLayout>
