  ...
  return (
    ...
    >
      ...
      <section id="verify" className="mb-12">
        <h2 className="text-2xl font-semibold text-slate-900 mb-4">Verify Your Email</h2>
        <p className="text-slate-400 mb-4">
        ...
        <div className="border border-slate-200 bg-white rounded-xl p-4 mb-4">
          <p className="text-sm text-slate-400">
            💡 <strong className="text-slate-900">Tip:</strong> Check your spam folder if you don't see the verification email within a few minutes.
          </p>
        </div>
      </section>

      <section id="profile" className="mb-12">
        <h2 className="text-2xl font-semibold text-slate-900 mb-4">Complete Your Profile</h2>
        <p className="text-slate-400 mb-4">
      ...
      <section id="plan" className="mb-12">
        <h2 className="text-2xl font-semibold text-slate-900 mb-4">Choose Your Plan</h2>
        ...
        <div className="grid gap-6">
          ...
          <div className="border border-slate-200 bg-white rounded-xl p-5">
            <div className="flex items-center gap-3 mb-3">
              <h4 className="text-slate-900 font-semibold text-lg">Founder</h4>
          ...
          {/* Scale */}
          <div className="border-2 border-[#7ba3e8]/50 bg-white rounded-xl p-5 relative">
            ...
            <ul className="text-sm text-slate-400 space-y-2">
              <li className="flex items-start gap-2">
                ...
                <span><strong className="text-slate-900">150 AI credits per month</strong> – 5x more queries for deeper insights</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-[#7ba3e8]">✓</span>
                <span><strong className="text-slate-900">25 monthly report downloads</strong> – Export more financial reports</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-[#7ba3e8]">✓</span>
                <span><strong className="text-slate-900">Advanced financial analysis</strong> – Deeper insights and trend detection</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-[#7ba3e8]">✓</span>
                <span><strong className="text-slate-900">Priority email support</strong> – Faster response times</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-[#7ba3e8]">✓</span>
                <span><strong className="text-slate-900">Up to 2 team collaborators</strong> – Work together on finances</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-[#7ba3e8]">✓</span>
                <span><strong className="text-slate-900">Credit add-ons available</strong> – Purchase more credits as needed</span>
              </li>
            </ul>
          </div>
          ...
          <div className="border border-slate-200 bg-white rounded-xl p-5">
            <div className="flex items-center gap-3 mb-3">
              <h4 className="text-slate-900 font-semibold text-lg">CFO</h4>
            ...
            <ul className="text-sm text-slate-400 space-y-2">
              <li className="flex items-start gap-2">
                ...
                <span><strong className="text-slate-900">250 AI credits per month</strong> – Maximum AI-powered analysis</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-slate-900">✓</span>
                <span><strong className="text-slate-900">Unlimited report downloads</strong> – No limits on exports</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-slate-900">✓</span>
                <span><strong className="text-slate-900">Advanced analysis & forecasting</strong> – Predictive insights for planning</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-slate-900">✓</span>
                <span><strong className="text-slate-900">Priority support</strong> – Top-tier assistance</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-slate-900">✓</span>
                <span><strong className="text-slate-900">Up to 6 team collaborators</strong> – Larger team access</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-slate-900">✓</span>
                <span><strong className="text-slate-900">Credit add-ons available</strong> – Scale as you grow</span>
              </li>
            </ul>
          </div>
          ...
          <div className="border border-slate-200 bg-white rounded-xl p-5">
            <div className="flex items-center gap-3 mb-3">
              <h4 className="text-slate-900 font-semibold text-lg">Enterprise</h4>
            ...
            <ul className="text-sm text-slate-400 space-y-2">
              <li className="flex items-start gap-2">
                <span className="text-slate-900">✓</span>
                <span><strong className="text-slate-900">Custom AI credits</strong> – Tailored to your usage</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-slate-900">✓</span>
                <span><strong className="text-slate-900">Unlimited report downloads</strong></span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-slate-900">✓</span>
                <span><strong className="text-slate-900">Custom team collaborators</strong> – Unlimited seats</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-slate-900">✓</span>
                <span><strong className="text-slate-900">Dedicated account manager</strong> – Personalized support</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-slate-900">✓</span>
                <span><strong className="text-slate-900">Custom integrations & APIs</strong> – Connect your systems</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-slate-900">✓</span>
                <span><strong className="text-slate-900">SLA guarantee & 24/7 support</strong> – Enterprise-grade reliability</span>
              </li>
            </ul>
