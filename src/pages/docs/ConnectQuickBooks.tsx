  ...
  return (
    ...
    >
      <section id="prerequisites" className="mb-12">
        ...
        <p className="text-vesta-navy-muted mb-4">Before connecting QuickBooks, ensure you have:</p>
      ...
      <section id="authorize" className="mb-12">
        ...
        <p className="text-vesta-navy-muted mb-4">
          Navigate to your Vesta dashboard and click the <strong className="text-vesta-navy">"Connect QuickBooks"</strong> button. 
        ...
        <div className="border border-vesta-navy/10 bg-white rounded-xl p-4 mb-4">
          <p className="text-sm text-vesta-navy-muted">
            💡 <strong className="text-vesta-navy">Tip:</strong> Make sure you're logged into the correct QuickBooks account before authorizing.
          </p>
        </div>
      </section>

      <section id="select-company" className="mb-12">
        <h2 className="text-2xl font-semibold text-vesta-navy mb-4">Step 2: Select Company</h2>
        <p className="text-vesta-navy-muted mb-4">
      ...
      <section id="troubleshooting" className="mb-12">
        ...
        <div className="space-y-4">
          <div className="border border-vesta-navy/10 bg-white rounded-xl p-4">
            <h4 className="text-vesta-navy font-medium mb-2">Connection Failed</h4>
            <p className="text-sm text-vesta-navy-muted">
              Try logging out of QuickBooks and logging back in, then attempt the connection again.
            </p>
          </div>
          <div className="border border-vesta-navy/10 bg-white rounded-xl p-4">
            <h4 className="text-vesta-navy font-medium mb-2">Missing Data</h4>
            <p className="text-sm text-vesta-navy-muted">
