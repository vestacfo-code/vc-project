  ...
  return (
    ...
    >
      <section id="overview" className="mb-12">
        ...
        <div className="border border-vesta-navy/10 bg-white rounded-xl p-4 mt-4">
          <p className="text-sm text-vesta-navy-muted">
            💡 <strong className="text-vesta-navy">Pro tip:</strong> Connect your accounting software for automatic invoice tracking and real-time AR updates.
          </p>
        </div>
      </section>

      <section id="at-risk" className="mb-12">
        <h2 className="text-2xl font-semibold text-vesta-navy mb-4">At-Risk Amounts</h2>
        <p className="text-vesta-navy-muted mb-4">
        ...
        <div className="grid gap-4">
          <div className="border border-vesta-navy/10 bg-white rounded-xl p-4">
            <h4 className="text-vesta-navy font-medium mb-2">Total At Risk</h4>
            <p className="text-sm text-vesta-navy-muted">Sum of invoices past due or with high-risk customers</p>
          </div>
          <div className="border border-vesta-navy/10 bg-white rounded-xl p-4">
            <h4 className="text-vesta-navy font-medium mb-2">Average Days Late</h4>
            <p className="text-sm text-vesta-navy-muted">Mean number of days invoices are overdue</p>
          </div>
          <div className="border border-vesta-navy/10 bg-white rounded-xl p-4">
            <h4 className="text-vesta-navy font-medium mb-2">Total Outstanding</h4>
            <p className="text-sm text-vesta-navy-muted">All unpaid invoices across your customer base</p>
          </div>
        </div>
      </section>

      <section id="payment-risk" className="mb-12">
        <h2 className="text-2xl font-semibold text-vesta-navy mb-4">Customer Payment Risk</h2>
        <p className="text-vesta-navy-muted mb-4">
        ...
        <p className="text-vesta-navy-muted mt-4">
      ...
      <section id="collection" className="mb-12">
        <h2 className="text-2xl font-semibold text-vesta-navy mb-4">Collection Insights</h2>
        <p className="text-vesta-navy-muted mb-4">
