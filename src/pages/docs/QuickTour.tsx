  ...
  return (
    ...
    >
      <section id="dashboard" className="mb-12">
        <h2 className="text-2xl font-semibold text-slate-900 mb-4">Dashboard Overview</h2>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <div className="border border-slate-200 bg-white rounded-xl p-4">
            <h4 className="text-slate-900 font-medium mb-2">Top Customers Chart</h4>
      ...
      <section id="features" className="mb-12">
        ...
        <ol className="list-decimal list-inside text-slate-400 space-y-3">
          <li><strong className="text-slate-900">AI Chat:</strong> Get instant answers about your business finances</li>
          <li><strong className="text-slate-900">Integrations:</strong> Connect QuickBooks, Xero, Wave, or Zoho</li>
          <li><strong className="text-slate-900">File Upload:</strong> Import CSV, Excel, or PDF documents</li>
          <li><strong className="text-slate-900">Forecasting:</strong> Predict future cash flow and revenue</li>
        </ol>
      </section>

      <section id="help" className="mb-12">
        <h2 className="text-2xl font-semibold text-slate-900 mb-4">Getting Help</h2>
        <p className="text-slate-400 mb-4">
