  ...
  return (
    ...
    >
      <section id="prerequisites" className="mb-12">
        ...
        <p className="text-vesta-navy-muted mb-4">Before connecting Wave, ensure you have:</p>
      ...
      <section id="authorize" className="mb-12">
        ...
        <p className="text-vesta-navy-muted mb-4">
          Click <strong className="text-vesta-navy">"Connect Wave"</strong> from your Vesta dashboard. 
        ...
        <div className="border border-vesta-navy/10 bg-white rounded-xl p-4 mb-4">
          <p className="text-sm text-vesta-navy-muted">
            💡 <strong className="text-vesta-navy">Note:</strong> Wave is free accounting software, perfect for small businesses and freelancers.
          </p>
        </div>
      </section>

      <section id="select-business" className="mb-12">
        <h2 className="text-2xl font-semibold text-vesta-navy mb-4">Step 2: Select Business</h2>
        <p className="text-vesta-navy-muted mb-4">
      ...
      <section id="troubleshooting" className="mb-12">
        ...
        <div className="space-y-4">
          <div className="border border-vesta-navy/10 bg-white rounded-xl p-4">
            <h4 className="text-vesta-navy font-medium mb-2">Connection Issues</h4>
            <p className="text-sm text-vesta-navy-muted">
              Clear your browser cache and try connecting again. Ensure pop-ups are allowed.
            </p>
          </div>
          <div className="border border-vesta-navy/10 bg-white rounded-xl p-4">
            <h4 className="text-vesta-navy font-medium mb-2">Limited Data</h4>
            <p className="text-sm text-vesta-navy-muted">
