    ...
    >
      ...
      <section id="authorize" className="mb-12">
        ...
        <div className="bg-[#1a1a1a] border border-white/10 rounded-xl p-4 mb-4">
          <p className="text-sm text-slate-400">
            💡 <strong className="text-white">Note:</strong> Wave is free accounting software, perfect for small businesses and freelancers.
          </p>
        </div>
      </section>

      <section id="select-business" className="mb-12">
        <h2 className="text-2xl font-semibold text-white mb-4">Step 2: Select Business</h2>
        <p className="text-slate-400 mb-4">
      ...
      <section id="troubleshooting" className="mb-12">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#1a1a1a] border border-white/10 rounded-xl p-4">
            <h4 className="text-white font-medium mb-2">Limited Data</h4>
            <p className="text-sm text-slate-400">
