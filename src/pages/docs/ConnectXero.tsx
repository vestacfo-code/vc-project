  ...
  return (
    ...
    >
      <section id="prerequisites" className="mb-12">
        ...
        <p className="text-vesta-navy-muted mb-4">Before connecting Xero, ensure you have:</p>
      ...
      <section id="authorize" className="mb-12">
        ...
        <p className="text-vesta-navy-muted mb-4">
          From your Vesta dashboard, click <strong className="text-vesta-navy">"Connect Xero"</strong>. 
        ...
        <div className="border border-vesta-navy/10 bg-white rounded-xl p-4 mb-4">
          <p className="text-sm text-vesta-navy-muted">
            💡 <strong className="text-vesta-navy">Tip:</strong> Review the permissions Vesta requests. We only access read-only financial data.
          </p>
        </div>
      </section>
      ...
      <section id="troubleshooting" className="mb-12">
        ...
        <div className="space-y-4">
          <div className="border border-vesta-navy/10 bg-white rounded-xl p-4">
            <h4 className="text-vesta-navy font-medium mb-2">Authorization Expired</h4>
            <p className="text-sm text-vesta-navy-muted">
              Xero connections expire after 60 days. Reconnect from your dashboard to refresh.
            </p>
          </div>
          <div className="border border-vesta-navy/10 bg-white rounded-xl p-4">
            <h4 className="text-vesta-navy font-medium mb-2">Rate Limits</h4>
            <p className="text-sm text-vesta-navy-muted">
