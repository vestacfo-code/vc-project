  ...
  return (
    ...
    >
      <section id="intelligence" className="mb-12">
        <h2 className="text-2xl font-semibold text-white mb-4">Intelligence Cards</h2>
      ...
      <section id="charts" className="mb-12">
        <h2 className="text-2xl font-semibold text-white mb-4">Charts & Visualizations</h2>
        <p className="text-slate-400 mb-4">
          Interactive charts help you understand your financial data at a glance:
        </p>
        <div className="grid gap-4 md:grid-cols-2">
          <div className="bg-[#1a1a1a] border border-white/10 rounded-xl p-4">
            <h4 className="text-white font-medium mb-2">Cash Flow Chart</h4>
            <p className="text-sm text-slate-400">Area chart showing cash inflows and outflows over time</p>
          </div>
          <div className="bg-[#1a1a1a] border border-white/10 rounded-xl p-4">
            <h4 className="text-white font-medium mb-2">Top Customers</h4>
          ...
          <div className="bg-[#1a1a1a] border border-white/10 rounded-xl p-4">
            <h4 className="text-white font-medium mb-2">Trend Lines</h4>
      ...
      <section id="insights" className="mb-12">
        ...
        <ul className="list-disc list-inside text-slate-400 space-y-2">
          <li><strong className="text-white">Strategic Alerts:</strong> Warnings about cash runway, concentration risks, and anomalies</li>
          <li><strong className="text-white">Trend Analysis:</strong> AI interpretation of patterns in your data</li>
          <li><strong className="text-white">Recommendations:</strong> Actionable suggestions to improve financial health</li>
          <li><strong className="text-white">Chat Integration:</strong> Click any chat icon to ask AI questions about that specific metric</li>
        </ul>
      </section>

      <section id="filters" className="mb-12">
        <h2 className="text-2xl font-semibold text-white mb-4">Filters & Export</h2>
        <p className="text-slate-400 mb-4">
        ...
        <ul className="list-disc list-inside text-slate-400 space-y-2">
          <li><strong className="text-white">CSV:</strong> Raw data for spreadsheets</li>
          <li><strong className="text-white">PDF:</strong> Formatted reports with charts</li>
          <li><strong className="text-white">PNG:</strong> Chart images for presentations</li>
        </ul>
      </section>
    </DocsLayout>
  );
