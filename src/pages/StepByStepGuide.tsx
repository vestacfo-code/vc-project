...
const StepByStepGuide = () => {
  ...
  const steps = [
    {
      number: 1,
      title: "Visit joinfinlo.ai",
      description: "Navigate to our homepage to get started.",
      image: "/lovable-uploads/5a419f92-d3d0-427f-a7b9-c9b2831afe31.png",
    ...
    },
    {
      ...
      image: "/lovable-uploads/416182e4-fa07-422b-85bc-af980dccf579.png",
    ...
    },
    {
      ...
      image: "/lovable-uploads/a190eaa8-2cbc-4287-b974-6f83072292ed.png",
    ...
    },
    {
      ...
      description: "Return to joinfinlo.ai and click Login to sign in with your new account credentials.",
      image: "/lovable-uploads/213eee80-97a9-46a5-adcc-16ea2a790b37.png",
      details: "Enter the email and password you created in step 2 to access your new Finlo account."
    },
    {
      number: 5,
      title: "Begin Onboarding",
      description: "Click 'Sign In' and then 'Continue' to start the personalized onboarding process.",
      image: "/lovable-uploads/d69a8f92-db68-4d4e-8274-42d11537d5ff.png",
    ...
    },
    {
      ...
      image: "/lovable-uploads/c6fd9404-ba1f-44b6-87fd-340a1f93e8a8.png",
    ...
    },
    {
      ...
      image: "/lovable-uploads/8594261b-8d73-43fd-a47d-b0ba3cabb794.png",
      ...
      <div className="container mx-auto px-6 py-8">
        ...
        <div className="text-center mt-16 pt-16 border-t border-white/20">
          ...
          <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
            Join hundreds of small businesses already using Finlo to gain AI-powered insights from their financial data.
          </p>
          <Button 
            size="lg" 
            variant="hero"
            onClick={() => window.open('https://joinfinlo.ai', '_blank')}
